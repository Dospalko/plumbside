        ...
        <Tabs defaultValue="profile" className="w-full">
          <TabsList className="grid w-full md:w-[400px] grid-cols-2 mb-6">
            <TabsTrigger value="profile" className="flex items-center gap-2">
              <UserCircle className="h-4 w-4" /> Osobný Profil
            </TabsTrigger>
              ...
              <CardContent className="p-6">
                <form onSubmit={handleUserSave} className="space-y-6">
                    ...
                    <div className="pt-4 border-t border-slate-100 mt-6">
                      <div className="space-y-2">
                        <label htmlFor="password" className="block text-sm font-semibold text-slate-700 flex justify-between">
                          ...
                          <span className="text-slate-400 font-normal text-xs">Voliteľné</span>
                        </label>
                        <input 
                          id="password" 
                          type="password" 
                          ...
                          placeholder="Zadajte iba ak chcete zmeniť súčasné heslo"
                          className="w-full h-10 border border-slate-200 rounded-lg px-3 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-slate-900 font-medium transition-all placeholder:font-normal placeholder:text-slate-400"
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-end pt-2">
                    <button 
                      type="submit" 
                      disabled={savingUser || (!fullName && !email)} 
                      className="h-10 px-6 bg-blue-600 text-white font-medium rounded-lg shadow-sm hover:bg-blue-700 transition-colors disabled:opacity-50 flex items-center gap-2"
                    >
                ...
                <form onSubmit={handleTenantSave} className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      placeholder="Napr. inštalatér Ján Novák"
                      className="w-full h-10 border border-slate-200 rounded-lg px-3 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-slate-900 font-medium transition-all"
                    />
                  ...
                  <div className="flex justify-end pt-2">
                    <button 
                      type="submit" 
                      disabled={savingTenant || !companyName.trim()} 
                      className="h-10 px-6 bg-blue-600 text-white font-medium rounded-lg shadow-sm hover:bg-blue-700 transition-colors disabled:opacity-50 flex items-center gap-2"
                    >
